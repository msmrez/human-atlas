 ...
 */
export async function decodeModelResponse(response:Response,expectedBytes:number,compressed:boolean,incomplete='An anatomy file was incomplete. Please reload the viewer.'):Promise<ArrayBuffer>{
 ...
 if(buffer.byteLength!==expectedBytes)throw new Error(incomplete);
 return buffer;
}
